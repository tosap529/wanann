    ...
    <div class="wrapper about">
        ...
        <section>
            <div class="about_bgc_img">
                <article>
                    <h1>"The objective of cleaning is not just to clean, but to feel happiness living within that
                        environment."
                    </h1>
                    <h1>---Marie Kondo</h1>
                    <h1>清潔的目標不僅僅是為了打掃，而是要在這個環境中感受到居住的幸福。</h1>
                </article>
            </div>
        </section>

        <section class="about_charity">
            <div class="title">
                <h1>企業貢獻</h1>
            </div>
            <article>
            ...
            <h2>如果您正在尋找一個可靠、專業的居家清潔服務，歡迎與浣安聯繫。
