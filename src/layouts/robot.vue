...
function chatback(userInput) {
    ...
    } else if (userInput.includes('運送')||userInput.includes('配送')) {
        return '我們目前僅提供宅配到府服務，若有其他問題，請來電洽詢客服人員02-12345678';
    } else {
